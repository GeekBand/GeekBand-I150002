...
-(void)loadMainFrame{
    ...
    UINavigationController *oneNavigation = [[UINavigationController alloc]initWithRootViewController:viewController1];
    viewController1.navigationItem.title = @"会拍";

    UITabBarController *tabBarController = [[UITabBarController alloc]init];
    [tabBarController setViewControllers:@[oneNavigation]];
