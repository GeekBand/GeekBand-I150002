...
-(void)grayscaleFilter
{
    ...
    UIImage * output = [grayscaleFilter imageFromCurrentFramebufferWithOrientation:backupPhoto.imageOrientation];
...
-(void)GaussianBlurFilter
{
    ...
    UIImage * output = [filter imageFromCurrentFramebufferWithOrientation:backupPhoto.imageOrientation];
...
-(void)FastFilter{
    ...
    changedPhoto = quickFilteredImage;
