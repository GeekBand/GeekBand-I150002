...
-(void)viewDidLoad{
    ...
    CGFloat mainwidth =mainImage.image.size.width*210/mainImage.image.size.height;
   [mainImage setFrame:CGRectMake((self.view.frame.size.width/2)-(mainwidth/2),80,mainwidth,310)];
    [self.view addSubview:mainImage];
    
    middleView = [[UIView alloc]initWithFrame:CGRectMake(0,400, self.view.frame.size.width, self.view.frame.size.height )];
...
-(void)MakePictureView{
    if (!self.PictureView) {
        self.PictureView = [[UITableView alloc]initWithFrame:CGRectMake(20,50,self.view.frame.size.width-40,774)];
